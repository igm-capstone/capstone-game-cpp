...
void Explorer::OnNetAuthorityChange(BaseSceneObject* obj, bool newAuth)
{
	...
	e->mMeleeColliderComponent.asSphereColliderComponent->mOffset = { 0.0f, 0.65f, e->mCollider->mCollider.radius + e->mMeleeColliderComponent.asSphereColliderComponent->mCollider.radius + 0.01f };

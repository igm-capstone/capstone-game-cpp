...
public:
	...
	void SetStateAnimation(AnimationControllerState state, const char* name, uint32_t startIndex, uint32_t endIndex, KeyframeOption* options, uint32_t count, bool shouldLoop);
